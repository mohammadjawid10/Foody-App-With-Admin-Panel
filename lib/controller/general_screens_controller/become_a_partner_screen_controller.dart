...
class BecomeAPartnerScreenController extends GetxController{
  ...
  Future<void> onSaveTap() async {
    ...
    isAllDataValid = !phoneValidation(phoneTEController.text) && isAllDataValid;
    ...
    if (isAllDataValid) {
      ...
      if(await CommonCode().checkInternetAccess()) {
        String response = await restaurantService.becomeRestaurant(name: nameTEController.text, email: emailTEController.text, zip: zipTEController.text, city: cityTEController.text, phone: phoneTEController.text, note: noteTEController.text);
        pd.dismissDialog();

...
import '../../controller/general_screens_controller/become_a_partner_screen_controller.dart';
...
class BecomeAPartnerScreen extends GetView<BecomeAPartnerScreenController>{
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          flex: 1,
                          child: Center(
                            child:    Text("becomeapartnerrestaurant".tr,textAlign:TextAlign.center,style: heading1SemiBold(color: AppColors.blackColor,fontSize: 25),),
                          ),
                        ),
                      ],
                    ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          labelText(label: "yourrestaurantphone".tr),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomTextField(
